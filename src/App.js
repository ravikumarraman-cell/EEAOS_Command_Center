...
import { LayoutDashboard, Globe, Compass, Layers, Sparkles, BookOpen, Cpu, Workflow, Activity, TrendingUp, PieChart, GitBranch, ShieldCheck, Lock, CheckCircle, Terminal, Search, ChevronDown, Settings } from "lucide-react";
const navigation = [
...
function getLinkIcon(path) {
    ...
    switch (path) {
        case "/": return _jsx(LayoutDashboard, { className: sizeClass });
        case "/governance": return _jsx(Globe, { className: sizeClass });
        case "/scenario-explorer": return _jsx(Compass, { className: sizeClass });
        case "/tier-explorer": return _jsx(Layers, { className: sizeClass });
        case "/recommendations": return _jsx(Sparkles, { className: sizeClass });
        case "/playbooks": return _jsx(BookOpen, { className: sizeClass });
        case "/ai-agent-studio": return _jsx(Cpu, { className: sizeClass });
        case "/agent-workflow": return _jsx(Workflow, { className: sizeClass });
        case "/executive": return _jsx(Activity, { className: sizeClass });
        case "/engineering-intelligence": return _jsx(TrendingUp, { className: sizeClass });
        case "/portfolio": return _jsx(PieChart, { className: sizeClass });
        case "/spec-dependencies": return _jsx(GitBranch, { className: sizeClass });
        case "/architecture-review": return _jsx(ShieldCheck, { className: sizeClass });
        case "/security-review": return _jsx(Lock, { className: sizeClass });
        case "/production-readiness": return _jsx(CheckCircle, { className: sizeClass });
        case "/release-control": return _jsx(Terminal, { className: sizeClass });
        default: return _jsx(Settings, { className: sizeClass });
    }
}
export default function App() {
    return (_jsxs("div", { className: "app-shell", children: [_jsxs("aside", { className: "sidebar", children: [_jsxs(Link, { className: "brand", to: "/", children: [_jsx("span", { className: "brand-mark", children: "E" }), _jsxs("div", { className: "brand-info", children: [_jsx("strong", { children: "EEAOS" }), _jsx("small", { children: "Command Center" })] })] }), _jsxs("div", { className: "workspace-chip", children: [_jsxs("div", { style: { display: "flex", alignItems: "center" }, children: [_jsx("span", { className: "status-dot" }), _jsx("span", { style: { marginLeft: "4px" }, children: "Delivery workspace" })] }), _jsx(ChevronDown, { className: "w-3.5 h-3.5 text-gray-500" })] }), _jsx("nav", { "aria-label": "Primary navigation", className: "sidebar-nav", children: navigation.map((section) => _jsxs("div", { className: "nav-section", children: [_jsx("p", { className: "nav-label", children: section.label }), section.items.map(([path, label]) => _jsxs(NavLink, { to: path, end: path === "/", className: ({ isActive }) => isActive ? "nav-link active group" : "nav-link group", children: [_jsx("span", { className: "nav-glyph", "aria-hidden": "true", children: getLinkIcon(path) }), label] }, path))] }, section.label)) }), _jsxs("div", { className: "sidebar-footer", children: [_jsxs("div", { style: { display: "flex", alignItems: "center" }, children: [_jsx("span", { className: "status-dot green" }), _jsx("span", { style: { marginLeft: "4px" }, children: "System healthy" })] }), _jsx("span", { children: "v0.1" })] })] }), _jsxs("div", { className: "app-content", children: [_jsxs("header", { className: "topbar", children: [_jsxs("div", { children: [_jsx("p", { className: "eyebrow", children: "Engineering operating system" }), _jsxs("p", { className: "breadcrumb", children: ["Workspace / ", _jsx("strong", { children: "Command Center" })] })] }), _jsxs("div", { className: "topbar-actions", children: [_jsx("button", { className: "icon-button", type: "button", "aria-label": "Search", children: _jsx(Search, { className: "w-4 h-4 text-zinc-500" }) }), _jsx("button", { className: "avatar", type: "button", "aria-label": "Open profile", children: "RK" })] })] }), _jsx("main", { className: "page-content", children: _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(Dashboard, {}) }), _jsx(Route, { path: "/scenarios", element: _jsx(Scenarios, {}) }), _jsx(Route, { path: "/scenario-explorer", element: _jsx(ScenarioExplorer, {}) }), _jsx(Route, { path: "/tier-explorer", element: _jsx(TierExplorer, {}) }), _jsx(Route, { path: "/recommendations", element: _jsx(RecommendationEngine, {}) }), _jsx(Route, { path: "/architecture-review", element: _jsx(ArchitectureReviewCenter, {}) }), _jsx(Route, { path: "/agent-workflow", element: _jsx(AgentWorkflowVisualizer, {}) }), _jsx(Route, { path: "/playbooks", element: _jsx(PlaybookLibrary, {}) }), _jsx(Route, { path: "/governance", element: _jsx(GovernanceDashboard, {}) }), _jsx(Route, { path: "/executive", element: _jsx(ExecutiveCommandCenter, {}) }), _jsx(Route, { path: "/security-review", element: _jsx(SecurityReviewCenter, {}) }), _jsx(Route, { path: "/production-readiness", element: _jsx(ProductionReadinessCenter, {}) }), _jsx(Route, { path: "/ai-agent-studio", element: _jsx(AIAgentStudio, {}) }), _jsx(Route, { path: "/engineering-intelligence", element: _jsx(EngineeringIntelligence, {}) }), _jsx(Route, { path: "/portfolio", element: _jsx(PortfolioManagement, {}) }), _jsx(Route, { path: "/spec-dependencies", element: _jsx(SpecDependencyGraph, {}) }), _jsx(Route, { path: "/release-control", element: _jsx(ReleaseControlCenter, {}) }), _jsx(Route, { path: "*", element: _jsx(Dashboard, {}) })] }) })] })] }));
}
