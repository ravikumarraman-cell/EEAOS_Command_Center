...
export default function ScenarioExplorer() {
    ...
    return (_jsxs("div", { className: "max-w-7xl mx-auto space-y-8 animate-in fade-in duration-300", children: [_jsxs("div", { className: "border-b border-zinc-200/60 pb-6", children: [_jsx("p", { className: "eyebrow accent", style: { fontWeight: 800, fontSize: "11px", letterSpacing: "0.14em" }, children: "AI Agent Studio" }), _jsx("h1", { className: "font-serif text-4xl md:text-5xl font-normal text-zinc-950 mt-1 tracking-tight", children: "Scenario Explorer" }), _jsx("p", { className: "text-zinc-500 text-sm mt-2 max-w-2xl leading-relaxed", children: "The autonomous system playbook directory and execution workspace. Choose a scenario on the left to orchestrate compliance rules and AI agents." })] }), _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-8 items-start", children: [_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "bg-white border border-zinc-200 rounded-2xl p-6 shadow-xs space-y-4", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("h3", { className: "text-xs font-bold text-zinc-400 uppercase tracking-wider font-mono", children: "System Scenarios Directory" }), _jsxs("span", { className: "text-[10px] bg-zinc-100 text-zinc-600 px-2 py-0.5 rounded font-mono font-bold", children: [scenarios.length, " Models"] })] }), _jsxs("div", { className: "relative", children: [_jsx(Search, { className: "absolute left-3.5 top-3.5 w-4 h-4 text-zinc-400" }), _jsx("input", { type: "text", placeholder: "Search engineering scenarios...", value: searchQuery, onChange: (e) => setSearchQuery(e.target.value), className: "w-full pl-11 pr-4 py-3 bg-zinc-50 border border-zinc-200 rounded-xl text-sm placeholder-zinc-400 focus:outline-hidden focus:ring-2 focus:ring-[#d94625]/20 focus:border-[#d94625] transition-all" })] }), _jsxs("div", { className: "space-y-2.5 max-h-[290px] overflow-y-auto pr-1", children: [filteredScenarios.map((s) => {
                                                const isSelected = selected.name === s.name;
                                                return (_jsxs("button", { onClick: () => setSelected(s), className: `w-full text-left p-3.5 rounded-xl border transition-all duration-200 flex items-center justify-between group relative overflow-hidden ${isSelected
                                            ...
                                            }), filteredScenarios.length === 0 && (_jsxs("div", { className: "p-8 text-center bg-white border border-dashed border-zinc-200 rounded-xl", children: [_jsx(HelpCircle, { className: "w-8 h-8 text-zinc-300 mx-auto mb-2" }), _jsx("p", { className: "text-zinc-500 text-xs font-semibold", children: "No matching scenarios found." })] }))] })] }), _jsxs("div", { className: "bg-white border border-zinc-200 rounded-2xl p-6 shadow-xs space-y-4", children: [_jsxs("div", { className: "flex items-center gap-2 border-b border-zinc-100 pb-3", children: [_jsx(FileText, { className: "w-4 h-4 text-[#d94625]" }), _jsx("h4", { className: "text-xs font-bold uppercase tracking-wider text-zinc-800", children: "Governing Playbooks" })] }), _jsx("p", { className: "text-xs text-zinc-400 leading-relaxed", children: "These compliance playbooks are bound to the currently selected scenario. Click on a standard below to audit its compliance criteria and review its checklists:" }), _jsx("div", { className: "space-y-2.5", children: selected.specs.map((specName) => {
                                            ...
                                            return (_jsxs("button", { type: "button", onClick: () => openSpecByName(specName), className: "group w-full flex items-start gap-3.5 p-4 text-left border border-zinc-200/80 hover:border-[#d94625] rounded-xl hover:bg-zinc-50 bg-white transition-all shadow-2xs", children: [_jsx("div", { className: "w-8 h-8 rounded-lg bg-[#d94625]/5 text-[#d94625] flex items-center justify-center font-serif text-sm font-bold group-hover:bg-[#d94625] group-hover:text-white transition-all shrink-0", children: specObj ? specObj.tier : "T1" }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsx("span", { className: "block text-xs font-bold text-zinc-900 group-hover:text-[#d94625] transition-colors truncate", children: specName }), _jsxs("span", { className: "block text-[10px] text-zinc-400 font-mono mt-0.5", children: [specObj ? specObj.id : "EEAOS-SPEC-XXX", " \u2022 Click to Audit"] })] }), _jsx(ChevronRight, { className: "w-4 h-4 text-zinc-300 group-hover:text-[#d94625] group-hover:translate-x-1 transition-all self-center shrink-0" })] }, specName));
                                        }) })] })] }), _jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "bg-zinc-900 border border-zinc-800 rounded-2xl p-6 md:p-8 text-white shadow-lg space-y-4", children: [_jsxs("div", { className: "flex flex-wrap items-center gap-2.5", children: [_jsxs("span", { className: `inline-block text-[9px] font-bold uppercase tracking-widest px-2.5 py-0.5 rounded-sm border ${getCriticalityBadge(selected.criticality)}`, children: [selected.criticality, " Priority"] }), _jsx("span", { className: "text-zinc-600", children: "\u2022" }), _jsxs("span", { className: "text-xs text-zinc-400 font-mono", children: ["SLA: ", selected.slaHours, " Hours"] })] }), _jsxs("div", { className: "space-y-1", children: [_jsx("h2", { className: "font-serif text-2xl md:text-3xl font-normal text-white", children: selected.name }), _jsx("p", { className: "text-xs sm:text-sm text-zinc-400 leading-relaxed", children: selected.desc })] })] }), _jsxs("div", { className: "bg-white border border-zinc-200 rounded-2xl p-6 shadow-xs space-y-4", children: [_jsxs("div", { className: "flex items-center justify-between border-b border-zinc-100 pb-3", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Cpu, { className: "w-4 h-4 text-[#d94625]" }), _jsx("h4", { className: "text-xs font-bold uppercase tracking-wider text-zinc-800", children: "Assigned Autonomous AI Agents" })] }), _jsxs("span", { className: "text-[10px] font-mono text-zinc-400", children: ["Active Workers: ", selected.agents.length] })] }), _jsx("div", { className: "space-y-4", children: selected.agents.map((agent) => (_jsxs("div", { className: "border border-zinc-200 bg-[#fcfcfc] rounded-xl p-4 flex flex-col justify-between space-y-3.5 hover:border-zinc-300 transition-colors", children: [_jsxs("div", { className: "space-y-2", children: [_jsxs("div", { className: "flex items-center gap-2.5", children: [_jsx("div", { className: "w-8 h-8 rounded-lg bg-zinc-900 text-white flex items-center justify-center shadow-xs", children: _jsx(User, { className: "w-4 h-4" }) }), _jsx("span", { className: "text-xs font-bold text-zinc-950 uppercase tracking-tight", children: agent.role })] }), _jsx("p", { className: "text-[11px] text-zinc-500 leading-relaxed", children: agent.description })] }), _jsxs("div", { className: "space-y-1.5 pt-2.5 border-t border-zinc-100", children: [_jsx("span", { className: "block text-[9px] font-bold text-zinc-400 uppercase tracking-wider", children: "Assigned Tools & Skillsets:" }), _jsx("div", { className: "flex flex-wrap gap-1", children: agent.tools.map((t) => (_jsx("span", { className: "text-[9px] font-mono font-medium text-zinc-600 bg-zinc-100 px-2 py-0.5 rounded-sm border border-zinc-200/40", children: t }, t))) })] })] }, agent.role))) })] }), _jsxs("div", { className: "bg-white border border-zinc-200 rounded-2xl p-6 shadow-xs space-y-4", children: [_jsxs("div", { className: "flex items-center gap-2 border-b border-zinc-100 pb-3", children: [_jsx(ShieldCheck, { className: "w-4 h-4 text-emerald-600" }), _jsx("h4", { className: "text-xs font-bold uppercase tracking-wider text-zinc-800", children: "Mandated Deliverables & Outputs" })] }), _jsx("div", { className: "space-y-2.5", children: selected.outputs.map((output) => (_jsxs("div", { className: "flex items-center gap-3 p-3.5 border border-emerald-100 bg-emerald-50/10 rounded-xl hover:border-emerald-200 transition-colors", children: [_jsx(CheckCircle2, { className: "w-4 h-4 text-emerald-500 shrink-0" }), _jsx("span", { className: "text-xs font-semibold text-zinc-800 leading-tight", children: output })] }, output))) })] })] })] }), _jsx(SpecDetailDrawer, { spec: selectedSpec, onClose: () => setSelectedSpec(null) })] }));
}
