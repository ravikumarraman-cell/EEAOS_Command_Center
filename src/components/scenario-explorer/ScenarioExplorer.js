                                        ...
                                        return (_jsxs("button", { onClick: () => setSelected(s), className: `w-full text-left p-4 rounded-xl border transition-all duration-200 flex items-center justify-between group relative overflow-hidden ${isSelected
                                                ...
                                                : "bg-white border-zinc-200/80 text-zinc-700 hover:border-zinc-300 hover:bg-zinc-50/50"}`, children: [isSelected && (_jsx("div", { className: "absolute left-0 top-0 bottom-0 w-1 bg-[#d94625]" })), _jsxs("div", { className: "pr-4 space-y-1", children: [_jsx("strong", { className: "block text-xs font-bold tracking-tight uppercase tracking-wider", children: s.name }), _jsx("span", { className: `inline-block text-[9px] px-2 py-0.5 rounded-sm border font-mono font-medium ${isSelected
                                                        ...
                                                        : "text-zinc-300 group-hover:text-zinc-500 group-hover:translate-x-1"}` })] }, s.name));
                                                                ...
                                                                return (_jsxs("button", { type: "button", onClick: () => openSpecByName(specName), className: "group w-full flex items-start gap-3 p-3.5 text-left border border-zinc-200/80 hover:border-[#d94625] rounded-xl hover:bg-zinc-50 bg-white transition-all", children: [_jsx("div", { className: "w-7 h-7 rounded-lg bg-[#d94625]/5 text-[#d94625] flex items-center justify-center font-serif text-xs font-bold group-hover:bg-[#d94625] group-hover:text-white transition-all shrink-0", children: specObj ? specObj.tier : "T1" }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsx("span", { className: "block text-xs font-bold text-zinc-900 group-hover:text-[#d94625] transition-colors truncate", children: specName }), _jsx("span", { className: "block text-[9px] text-zinc-400 font-mono mt-0.5", children: specObj ? specObj.id : "EEAOS-SPEC-XXX" })] }), _jsx(ChevronRight, { className: "w-4 h-4 text-zinc-300 group-hover:text-[#d94625] group-hover:translate-x-1 transition-all self-center shrink-0" })] }, specName));
                                                            }) })] }), _jsxs("div", { className: "space-y-3 pt-5 border-t border-zinc-100", children: [_jsxs("div", { className: "flex items-center gap-2 text-zinc-800", children: [_jsx(ShieldCheck, { className: "w-4 h-4 text-emerald-600" }), _jsx("h4", { className: "text-xs font-bold uppercase tracking-wider", children: "Mandated Deliverables" })] }), _jsx("div", { className: "space-y-2", children: selected.outputs.map((output) => (_jsxs("div", { className: "flex items-center gap-3 p-3.5 border border-emerald-100 bg-emerald-50/10 rounded-xl hover:border-emerald-200 transition-colors", children: [_jsx(CheckCircle2, { className: "w-3.5 h-3.5 text-emerald-500 shrink-0" }), _jsx("span", { className: "text-xs font-semibold text-zinc-800 leading-tight", children: output })] }, output))) })] })] })] })] }) })] }), _jsx(SpecDetailDrawer, { spec: selectedSpec, onClose: () => setSelectedSpec(null) })] }));
}
